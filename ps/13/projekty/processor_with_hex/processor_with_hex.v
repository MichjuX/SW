module processor_with_hex(
	...
	output [6:0] RH0_Q, RH1_Q, RH2_Q, RH3_Q);
	...
	regn #(7) RH0(DOUT[6:0], RH_E[0], Clock, RH0_Q);
	regn #(7) RH1(DOUT[6:0], RH_E[1], Clock, RH1_Q);
	regn #(7) RH2(DOUT[6:0], RH_E[2], Clock, RH2_Q);
	regn #(7) RH3(DOUT[6:0], RH_E[3], Clock, RH3_Q);
