module processor_with_SW_on_board(
	input [9:0] SW,
	input CLOCK_50,
	output [8:0] LEDR);

	processor_with_SW proc(SW, CLOCK_50, LEDR);
...
module processor_with_SW(
	...
	processor_2 proc(DIN, 1'b1, Clock, 1'b0, ADDR, DOUT, wr_en);
	// multiplekser
	wire [8:0] RS0_Q;
	wire RS1_Q;
	always @ (*)
		case (ADDR[8:7])
			2'b00: DIN = q;
			2'b01: DIN = RS0_Q;
			2'b10: DIN = { 8'b00000000, RS1_Q };
			default: DIN = 9'b000000000;
		endcase
	regn #(9) RS0(SW[8:0], 1'b1, Clock, RS0_Q);
	regn #(1) RS1(SW[9], 1'b1, Clock, RS1_Q);
